      ...
      .then((res) => {
        ...
        if(res.code==0){
            ...
            if(this.state.thisAppId){
                ...
                window.location.href='https://open.weixin.qq.com/connect/oauth2/authorize?appid='+this.state.thisAppId+'&redirect_uri='+url+'&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect'
