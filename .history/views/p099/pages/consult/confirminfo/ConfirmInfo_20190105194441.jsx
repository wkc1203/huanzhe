    ...
    createOrder(params) {
        ...
        Api
            ...
            .then((res) => {
                if (res.code == 0) {
                    imgList=[];
                    var replaceUrl=window.location.origin+"/views/p099/#/consult/pay?orderId="+res.data.orderId+"&totalFee="+
                                    ...
                                    <div className='img-box'
                                        ...
                                        <div className='img-add'
                                            ...
                                            <Icon value="clear"
                                                ...
                                                />
                                            <div>
                                                <img src={item.indexOf("ihoss")=='-1'?item:item+"?x-oss-process=image/resize,w_105"}
                                                     onClick={()=>{
