            ...
            .then((res) => {
                if(res.code==0){
                    ...
                    wx.config({
                        ...
                        jsApiList: ['hideMenuItems','showMenuItems','chooseImage','getLocalImgData','hideMenuItems', 'showMenuItems','previewImage','uploadImage','downloadImage'] // 必填，需要使用的JS接口列表
                    });
                    wx.ready(function(){
            ...
            wx.chooseImage({
                ...
                success: function (res) {
                    ...
                    wx.getLocalImgData({
                        ...
                        success: function (res) {
                            var localData = "data:image/png;base64,base64,"+res.localData; // localData是图片的base64数据，可以用img标签显示
                          // alert("hh"+localData)
                         
                            that.setState({
                                img:localData 
                            })
                            alert("s"+that.state.img)
                        },
                        fail:function(){
                             
                            alert("s1"+that.state.img)
                        }
                    })
