...
class Widget extends Component {
  ...
  componentDidMount() {
   ...
   hasOpenId(){
    ...
    if(window.localStorage.openIds&& (window.localStorage.isAuth!=undefined && window.localStorage.isAuth=='authed')){
        this.sum('index',1,window.localStorage.openIds);
        this.sum('index_inquiry_img',1,window.localStorage.openIds);
        this.sum('index_good_more',1,window.localStorage.openIds);
}else{
    ...
    if(window.location.search.indexOf("openId=")!=-1 && (window.localStorage.isAuth!=undefined && window.localStorage.isAuth=='authed')){
        has=window.location.search.substring(window.location.search.indexOf("openId=")+7,length);
            console.log(window.location.search.indexOf("openId="),has);
            window.localStorage.openIds=has;
            window.location.href=replaceUrl;
    }else{
        window.localStorage.isAuth="authed";
        window.localStorage.removeItem('openIds');
        window.location.href=replaceUrl;
    }
}
