            ...
            .then((res) => {
                if(res.code==0){
                    ...
                    wx.config({
                        ...
                        jsApiList: ['updateTimelineShareData','getLocalImgData','previewImage','hideMenuItems','showMenuItems','chooseImage','getLocalImgData','hideMenuItems', 'showMenuItems','previewImage','uploadImage','downloadImage'] // 必填，需要使用的JS接口列表
                    });
                    wx.ready(function(){
