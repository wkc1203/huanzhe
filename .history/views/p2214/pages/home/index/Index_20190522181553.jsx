      ...
      />}
          ...
          {<div className="content">
           <div className="head-des">  
              <div className="f-pa">
                <InquiryType url='/consult/alldeptlist' img='./././resources/images/index-inquiry-doctor.png' txt='医生咨询' txt1='健康问题问医生'/>
                <InquiryType url='' img='./././resources/images/index-drug.png' txt='用药咨询' txt1='合理用药问药师'/>
                <InquiryType url='' img='./././resources/images/index-nurse.png' txt='护理咨询' txt1='健康护理问护士'/>
              </div>
           </div>
           ...
           <div className='titleh'>
            ...
            />更多服务</div>
           <div className='b-tab'>
            <Func isOpen={false}  url='/microweb/deptlist' img='./././resources/images/index-dept.png' txt='科室介绍' txt1='了解医院科室' />
            <Func  isOpen={false} url='/microweb/deptlistfordoc' img='./././resources/images/index-doctor.png' txt='专家介绍' txt1='了解专家信息' />
            <Func isOpen={false} url='/microweb/news' img='./././resources/images/index-advice.png' txt='健康宣教' txt1='儿童护理知识' />
            <Func  isOpen={false} url='' href='https://mp.weixin.qq.com/s/QtsB23jZXQtem5HFDy-GVA' img='./././resources/images/index-inform.png' txt='咨询公告' txt1='查看最新公告' />
            </div>
         </div>}
          {this.props.isOpen&&<NoMessage />}
