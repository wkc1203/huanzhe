            ...
            .then((res) => {
                if(res.code==0){
                    ...
                    wx.config({
                        ...
                        jsApiList: ['previewImage','hideMenuItems','showMenuItems','chooseImage','getLocalImgData','hideMenuItems', 'showMenuItems','previewImage','uploadImage','downloadImage'] // 必填，需要使用的JS接口列表
                    });
                    wx.ready(function(){
            ...
            wx.chooseImage({
                ...
                success: function (res) {
                    ...
                    var m=localIds[0];
                        ...
                        wx.previewImage({
                            current: that.state.img, // 当前显示图片的http链接
                            urls: [that.state.img] // 需要预览的图片http链接列表
                            });
