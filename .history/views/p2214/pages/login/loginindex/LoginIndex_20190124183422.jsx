                    ...
                    <div className='modal-body-protocol'>
                        ...
                        <div className='modal-content-protocol'>
                            <div >
                                ...
                                <div className="content-item">1.	目的
                                在患者使用我院互联网医院平台时，给予患者提供各项服务的同时，承诺接受并遵守各项相关规则的规定。
                                </div>
                                <div className="content-item">2.	范围
使用互联网医院平台的医师、药师、患者及其家属
</div>
                                <div className="content-item">3.	定义
                                ...
                                <div className="content-item">3.2	知情同意权：患者和家属在享有知情权的同时，某些（具体范围见互联网医院患者知情同意书）服务的实施必须征得患者和家属的同意，必须履行互联网医院平台患者知情同意书签字手续。</div>
                                <div className="content-item">4.	标准
                                ...
                                者家属展示互联网医院《患者知情同意书》，家属强制阅读并选择是否签署同意书。
                                    ...
                                    <div className="content-item">5.	监管
                                    医务部、互联网医院管理办公室、质管办等相关职能部门对患者知情同意制度落实情况进行监控，不定期进行抽查，发现落实不到位的及时纠正，情节严重者追究相关法律责任。
                                    </div>   
                                    <div className="content-item">6. 参考文件：人大常委会《侵权责任法》、国务院《医疗机构管理条例》、《互联网诊疗管理办法（试行）》、《互联网医院管理办法（试行）》和《远程医疗服务管理规范（试行）》； </div>  
                                ...
                                <div className="content-item">尊敬的用户：</div>
                                <div className="content-item">欢迎使用重医儿童医院互联网医院！（以下简称互联网医院）</div>
                                <div className="content-item">服务协议说明：本协议是用户与互联网医院之间关于使用本服务所订立的协议，技术支持由…..提供。用户确认本服务协议后，本服务协议即在用户和互联网医院产生法律效力。请用户务必在注册、使用提供的服务之前认真阅读全部服务协议内容，如有任何疑问，可向互联网医院客服咨询。</div>
                                <div className="content-item">注册提醒：平台服务于18周岁以下患者，但注册用户只能是患者监护人，监护人必须认真阅读本协议。本协议一旦签署即默认签署人是监护人。无论用户是否阅读完本服务协议，只要按照平台注册流程成功注册，即表示用户与互联网医院达成一致，成为互联网医院平台用户。用户的注册行为将被认为是对本协议全部条款接受和遵守。阅读本协议的过程中，如果用户不同意本协议或其中任何条款约定，用户应立即停止注册流程。</div>
                                <div className="content-item">互联网医院：指重庆医科大学附属儿童医院的网络医院，依托微信平台建立在我院公众号内的互联网医院，暂无其他合作医院及平台</div>
                                <div className="content-item">互联网医院管理规定：平台服务的医生、药师、工作人员均属于重庆医科大学附属儿童医院员工，不涉及外聘其他医院专家等情况</div>
                              
                                <div className="content-title">一、 用户及注册：</div>
                                <div className="content-item">(一)	互联网医院提供用户注册。用户的帐号和密码由用户自行保管；用户应当对以用户的帐号进行的所有活动和事件负法律责任。<div className="content-item">4.2
                                    用户如在使用过程中实施不正当行为，本平台有权终止服务，由此造成的法律和经济后果由用户承担，不正当行为包含但不限于以下方面：
                                </div>
                                <div className="content-item">(二)	用户注册时，在账号名称、头像和简介等注册信息中不得出现违法和不良信息，否则互联网医院有权拒绝提供服务，并删除该账号。<div className="content-item">（2） 用户从中国境内向外传输技术性资料时违背中国有关法律法规行为；</div>
                                <div className="content-item">(三)	注册用户即为患者监护人，是具备完全民事行为能力的自然人。无民事行为能力人、限制民事行为能力人的个人不当注册，如使用了平台收费服务，其与互联网医院之间的服务协议自始无效，一经发现，互联网医院有权立即注销该用户，并追究其使用互联网医院“服务”的一切法律责任。 <div className="content-item">（4）
                                    用户以包括但不限于盗用他人账号、恶意编造或虚构信息、恶意投诉、未经允许进入他人电脑或手机系统等方式干扰或扰乱本服务；
                                </div>
                                <div className="content-item">(四)	用户有权利要求在互联网医院上所填写的个人信息完全保密（不包含网络使用名，网名不允许使用真实姓名）。一旦发现用户提供的个人信息中有虚假，互联网医院有权立即终止向用户提供的所有服务，并冻结用户，并有权要求用户承担因为提供虚假信息给医生及平台造成的损失。 </div>
                                <div className="content-item">(五)	用户在平台选择服务时，根据自己的情况选择并判断适合自己的咨询科室，平台提供智能导诊服务。 </div>
                                <d<div className="content-title">二、互联网医院服务内容：</div>
                                <div className="content-item">1.	互联网医院服务的具体内容由互联网医院经营者提供，互联网医院经营者保留随时变更、中断或终止部分或全部网络服务的权利。</div>
                                <div className="content-item">2.	互联网医院作为医生、患者间交流互通平台，用户通过互联网医院发表的各种言论（包括但不仅限于咨询问题、就医经验、感谢信等），并不代表互联网医院赞同用户的观点或证实其内容的真实性。</div>
                                <div className="content-item">3.	用户在互联网医院上获得的医生答复、医学文章信息等，不能作为用户采取治疗方案的直接依据。如确有必要，用户应当联系医生进行面对面的诊疗。平台提供在线加号服务。
                                <div className="content-item">4.	互联网医院提供部分常见病、慢性病患者复诊服务，并为在我院线下平台明确诊断为某种或某几种常见病、慢性病后的患者，可针对相同诊断的疾病在线开具处方。</div>
                                <div className="content-item">5.	互联网医院在提供网络服务时，可能会对部分服务收取一定费用，互联网医院将会对收费服务给予明确的提示，如用户拒绝支付此类费用，互联网医院有权不提供相关服务。</div>
                                ...
                                <div className="content-item">7.	因不可抗力、网络状况、通讯线路、用户自身技术过错等原因，或其他不可控原因导致用户不能正常使用互联网医院服务，互联网医院不承担相应责任。</div>
                            
                              
                                <div className="content-title">三、用户的权利和责任：</div>
                                <div className="content-item">1.	用户有权利拥有自己在互联网医院的用户名及密码，并有权利使用自己的用户名及密码随时登陆互联网医院服务。</div>
                                <div className="content-item">2.	用户不得以任何形式转让或授权他人使用自己的互联网医院用户名，亦不得盗用他人帐号，由以上行为造成的后果由用户自行承担。</div>
                                <div className="content-item">3.	用户有权根据互联网医院管理规定发布、获取信息，进行医患互通交流等。因互联网医院电话咨询及图文咨询均只限于用户的主观描述，不能面诊，所以用户在平台上提供的咨询信息必须保证真实，有效，不得提供虚假信息，否则有可能造成医生、药师的错误判断以及错误结果。医生尽可能利用医学知识及临床经验给予一定的解惑及如何就医方面的建议，不保证满足患者要求的诊断、治疗方面的建议一定能获得，也不保证这次咨询一定达到用户的预期目的。擅自将网上医生建议做为处方使用的，后果自负，与医生及互联网医院平台无关。</div>
                                <div className="content-item">4.	用户在咨询过程中要语言文明，尊重医生，平等交流。如有对医生恶意中伤，语言不文明，医生有权立即中断服务，此类服务，用户无权要求退款。</div>
                                    <div className="content-item">5.	咨询过程中遇到医生有紧急事情处理时（医生职业要求），要给予理解，暂停咨询，向互联网医院客服申报，以便安排重新咨询的具体时间。 </div>
                                    <div className="content-item">6.	用户必须遵守国家关于互联网信息发布的相关法律法规，用户对自己在互联网医院上发布的信息承担责任，用户不得发布违法信息，不得恶意评价其他用户。用户承诺自己在使用互联网医院时实施的所有行为均遵守国家法律、法规和互联网医院管理规定以及社会公共利益或公共道德。 如用户违反上述任一规则，导致相应法律后果的发生，用户将以自己的名义独立承担所有法律责任。</div>
                                ...
                                <div className="content-item">8.	用户不得将涉及医疗纠纷的问题或其它有责任争议的问题在互联网医院发布，关于医疗纠纷的问题，请另行咨询律师或相关主管部门寻求援助，互联网医院有权将此类信息删除。</div>
                                ...
                                <div className="content-item">保护用户的隐私是互联网医院的一项基本政策，互联网医院保证不对外公开或向第三方提供用户的注册资料及用户在使用网络服务时存储的非公开内容，但下列情况除外：事先获得用户的明确授权；根据有关的法律法规要求；按照相关政府主管部门的要求；为维护社会公众的利益；为维护互联网医院的合法权益。</div>
                                ...
                                <div className="content-title">九、服务条款修改：</div>
                                <div className="content-item">1.	互联网医院有权根据服务情况变更、终止互联网医院管理规定的各项条款，互联网医院将会通过适当方式向用户提示修改内容。</div>
                                <div className="content-item">2.	如果用户不同意互联网医院管理规定所做的修改，有权停止使用网络服务。如果用户继续使用网络服务，则视为用户接受互联网医院对服务协议相关条款所做的修改。</div>
                              
                                <div className="content-title">十、法律管辖：</div>
                                <div className="content-item">1.	本服务协议的效力、变更、执行和解释及争议的解决均应适用中华人民共和国法律，没有相关法律规定的，参照通用国际商业惯例和（或）行业惯例。</div>
                                <div className="content-item">2.	如双方就本服务协议内容或其执行发生任何争议，双方应尽量友好协商解决；协商不成时，任何一方均可向互联网医院经营者所在地的人民法院提起诉讼。</div>
                                <div className="content-title">十二、其他规定：</div>
                                <div className="content-item">您对本协议理解和认同，即是对本协议所有组成部分的内容理解并认同，一旦您使用平台提供的服务，您和互联网医院即受本协议所有组成部分的约束。本协议中的部分条款被有管辖权的法院认定为无效时的，不因此影响其他协议内容的效力。
