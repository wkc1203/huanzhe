            ...
            <div className='page1-pay'>
                ...
                <div className='fee-box'>
                    ...
                    {this.props.location.query.source=="check"&&noPay&&<div className='fee-item'>
                        ...
                        <span style={{fontSize:'18px'}}>￥</span>{(addInfo.isPay=='1'||this.props.location.query.isPay=='1')?(checkDetail.totalFee/100).toFixed(2)||'0.00':((addInfo.fees/100)+(checkDetail.totalFee/100)).toFixed(2)}
                    ...
                    <div className="content">
                        <div className="list">
                            ...
                            <div className="list-item">
                                ...
                                {this.props.location.query.isPay=='1'&&<div className="item-value">￥{this.props.location.query.addFee||'0.00'}</div>}
