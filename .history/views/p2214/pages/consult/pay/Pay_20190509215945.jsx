            ...
            .then((res) => {
                if(res.code==0){
                    ...
                    if(res.data.isPay=='1'){
                        ...
                        if((res.data.isPay=='0'&&res.data.orederStatus=='2'&&res.data.isVisit=='0')||(res.data.isPay=='1'&&res.data.orederStatus=='1'&&res.data.isVisit=='2')){
                             this.update();
                    ...
                    <div className="content">
                        <div className="list">
                            ...
                            <div className="list-item">
                                ...
                                {this.props.location.query.status!=='1'&&<div className="item-value">￥{(!!addInfo.fees?(addInfo.fees/100).toFixed(2):'')||'0.00'}</div>}
                                {this.props.location.query.status=='1'&&<div className="item-value">￥{(!!this.props.location.query.addFee?this.props.location.query.addFee:'')||'0.00'}</div>}
                            ...
                            <div className="list-item">
                                ...
                                <div className="item-value">{addInfo.isPay=='1'?'已支付':'未支付'}</div>
                            </div>
