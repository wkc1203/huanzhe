        ...
        return (
            <div className='page1-pay'>
                ...
                <div className='fee-box'>
                    ...
                    {this.props.location.query.source=="check"&&addInfo.hasPay!=='0'&&<div className='fee-item'>
                        <div className='des-fee'>待缴费金额（元）</div>
                        
                        <span style={{fontSize:'18px'}}>￥</span>{(addInfo.hasPay!=='0'||this.props.location.query.isPay=='1')?(checkDetail.totalFee/100).toFixed(2)||'0.00':((addInfo.totalFee)+(checkDetail.totalFee/100)).toFixed(2)}
                    ...
                    <div className="content">
                        <div className="list">
                            ...
                            <div className="list-item">
                                ...
                                {<div className="item-value">￥{(!!addInfo.totalFee?(addInfo.totalFee).toFixed(2):'')||'0.00'}</div>}
