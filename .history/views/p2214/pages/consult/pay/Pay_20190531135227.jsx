        ...
        return (
            <div className='page1-pay'>
                <div className="home"><span className="jian"
                                            onClick={()=>{
                                                 if(this.props.location.query.source){
                                                     if(this.props.location.query.source=='1'||this.props.location.query.source=='2'){
                                                        this.context.router.push({
                                                            pathname:'add/addManage',
                                                            query:{
                                                                id:this.props.location.query.hospitalTradeno,
                                                                source:2,
              ...
              {this.props.location.query.source!="check"&&<div className="mm-list">
                ...
                {<div className='btn'>
                 ...
                 this.confirmPay()
                    ...
                    {(this.props.location.query.source=="1"||this.props.location.query.source=="2")&&
                    <button  className="submit-btn" onClick={()=>{
                 this.confirmPay1()
                 }}>
                        立即支付
