                       ...
                       <div className="main-func">
                        ...
                        { docInfo.inquirys && docInfo.inquirys.map((item2, index2)=> {
                                return (
                                    ...
                                    <Status  key={index2} type={item2.type} type={item2.isOnDuty} type={item2.isFull} remune={item2.remune}
                                    img="./././resources/images/doctor-picture.png" txt='已满'  txt1='图文咨询'></Status>
                        ...
                        { docInfo.inquirys && docInfo.inquirys.map((item2, index2)=> {
                            return (
                                <Status  key={index2} type={item2.type} type={item2.isOnDuty} type={item2.isFull} remune={item2.remune}
                                 img="./././resources/images/doctor-picture.png" txt='离线'  txt1='图文咨询'></Status>
                        ...
                        <div className="main-func1">
                            <DoctorInfo1 img='./././resources/images/doctor-report.png' txt='报告解读' txt1='免费报告解读'></DoctorInfo1>
                            <DoctorInfo1 img='./././resources/images/doctor-check.png' txt='检验检查' txt1='在线申请检验检查'></DoctorInfo1>
                            <DoctorInfo1 img='./././resources/images/doctor-check.png' txt='慢病/处方' txt1='在线申请处方'></DoctorInfo1>
                        </div>
                    </div>
                    <DoctorIntro img='./././resources/images/doctor-special.png' txt='擅长领域' txt1={docInfo.specialty || '暂无描述'}></DoctorIntro>
                    <DoctorIntro img='./././resources/images/doctor-intro.png' txt='医生介绍' txt1={docInfo.introduction || '暂无介绍'}></DoctorIntro>
                ...
                {isShowProtocol && <div className='modal1'>
                    <div className='modal-body-protocol'>
                        ...
                        <div className='modal-content-protocol'>
                            <div className="content">
                                <div className="content-item">您即将向{docInfo.name}医生进行图文咨询，
                                试运行期间<span
