        ...
        return (
            <div className="page-dept-detail container1">
                ...
                {isFavorite && <img    className='advice1img'  
                    ...
                    <div className='data'>
                        <DataItem serviceTimes={docInfo.serviceTimes} txt='服务'>  </DataItem>
                        <DataItem serviceTimes='90' txt='好评率'>  </DataItem>
                        <DataItem serviceTimes={docInfo.workingLife} txt='从业年限'>  </DataItem>
                        <div className='item'>
