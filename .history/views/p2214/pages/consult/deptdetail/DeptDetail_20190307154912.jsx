        ...
        return (
            <div className="page-dept-detail container1">
                ...
                <div className='header2' id="head">
                    <div className='doctor2'>
                        ...
                        <div className='text1-box'>
                            <div>
                            {docInfo.name}   {docInfo.deptName} | {docInfo.level}
                            {
                            ...
                            <div className='advise'>
                                  ...
                                  <img  style={{width:'17px',height:'12px'}}
                                    onClick={()=>{
                                            this.context.router.push({
                                                pathname:'usercenter/complain',
                                                query:{type:1,deptName:docInfo.deptName,deptId:docInfo.deptId,doctorName:docInfo.name,doctorId:docInfo.doctorId}
                                ...
                                <div className='advise1'>
                                <span className='advice' >请关注</span>
                                {isFavorite && <img   style={{width:'20px',height:'20px'}}
                                onClick={()=>{
                ...
                <div className='data'>
                    ...
                    <div className='item'>
                        <div>好评率</div>
                        <div>{/* docInfo.favoriteRate */}98%</div>
                    </div>
                    <div className='item'>
                        <div>从业年限</div>
