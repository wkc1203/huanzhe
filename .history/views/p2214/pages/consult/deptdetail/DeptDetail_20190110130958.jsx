                ...
                <div className="home" id="home"><span className="jian"
                                            ...
                                            if(this.props.location.query.resource==2){
                                                ...
                                                this.context.router.push({
                                                    ...
                                                    query:{deptId:this.state.docInfo.deptId,doctorName:this.state.docInfo.deptName,source:1}
                                                    })
                        ...
                        { docInfo.inquirys && docInfo.inquirys.map((item1, index1)=> {
                            return (
                                <div key={index1}
                                     ...
                                     className={` ${item1.type=='1'&&item1.isOnDuty=='1'&&item1.isFull=='0'?'inquity-item':''}`}>
                                    <div className='icon'>
                                        {item1.type=='1'&&item1.isOnDuty=='1'&&item1.isFull=='0'&&<img src="../../../resources/images/inquiry-bg.png"/>}
                                        {item1.type=='1'&&(item1.isOnDuty=='0'||item1.isFull=='1')&&<img src="../../../resources/images/inquiry-gray.png"/>}
                                    </div>
                                    <div className='text'>
                                        {item1.type=='1'&&item1.isOnDuty=='1'&&item1.isFull=='0'&&<div>图文咨询</div>}
                                        {item1.type=='1'&&(item1.isOnDuty=='0'||item1.isFull=='1')&&<text className="f-color-gray">图文咨询</text>}
