...
//写入b字段
                    wx.config({
                        ...
                        jsApiList: ['previewImg','chooseImage','getLocalImgData','hideMenuItems', 'showMenuItems','previewImage','uploadImage','downloadImage'] // 必填，需要使用的JS接口列表
                    });
                    wx.ready(function () {
//批量隐藏功能
                        wx.hideMenuItems({
   ...
   /*切换咨询目的*/
    ...
    display(){
     ...
     wx.previewImage({
                current:'https://ihoss.oss-cn-beijing.aliyuncs.com/PIC/2019/01/31/21a021a0-21a0-21a0-21a0-21a021a021a0.png', // 当前显示图片的http链接
                urls: ['https://ihoss.oss-cn-beijing.aliyuncs.com/PIC/2019/01/31/21a021a0-21a0-21a0-21a0-21a021a021a0.png'] // 需要预览的图片http链接列表
            });}
    /*保存内容*/
    saveContent(e) {
        this.setState({
  ...
  onTabChange = (key) => {
    ...
    render() {
        const {signature,codeUrl,cardShow,policy,msg,callback,OSSAccessKeyId,open1,docInfo,cardList,consultList,imgArr,leftBindNum,
            selectName,sign,selectSex,selectBirthday,toptip,files}=this.state;
