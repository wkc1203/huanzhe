                ...
                if(length>4){
                    ...
                    for(var i=0;i<localIds.length;i++){
                        wx.getLocalImgData({
                            ...
                            success: function (res) {
                                var localData = that.base64ToBlob(res.localData); // localData是图片的base64数据，可以用img标签显示
                                ...
                                $.ajax({
                                    ...
                                    success: (e) => {
                                        ...
                                        wx.previewImage({
                                            current: 'https://ihoss.oss-cn-beijing.aliyuncs.com/'+filename, // 当前显示图片的http链接
                                            urls: ['https://ihoss.oss-cn-beijing.aliyuncs.com/'+filename] // 需要预览的图片http链接列表
                                            });
                                    },
                                    error:(e) =>{
                                        that.hideLoading();
