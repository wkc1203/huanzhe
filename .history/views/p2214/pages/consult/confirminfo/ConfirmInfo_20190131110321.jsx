...
//批量隐藏功能
   ...
   /*切换咨询目的*/
    ...
    alert("s")
     wx.previewImage({
                current:'http://ihoss.oss-cn-beijing.aliyuncs.com/PIC/2019/01/31/21a021a0-21a0-21a0-21a0-21a021a021a0.png', // 当前显示图片的http链接
                urls: ['http://ihoss.oss-cn-beijing.aliyuncs.com/PIC/2019/01/31/21a021a0-21a0-21a0-21a0-21a021a021a0.png'] // 需要预览的图片http链接列表
            });}
    /*保存内容*/
    saveContent(e) {
        this.setState({
