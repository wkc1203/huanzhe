    ...
    getDocList(deptId = '',page) {
        if(page==1){
           ...
           alert(page,deptId);
            ...
            this.showLoading();
            Api
                .getInfo({numPerPage:3, deptId, vagueName: '',pageNum:page})
                .then((res) => {
                    this.hideLoading();
   ...
   /*搜索*/
    search(value) {
         ...
         console.log("yyy",this.state.inquiryPage,this.state.incurrent)
          alert(this.state.inquiryPage,value);
            Api
            .getInfo({numPerPage:3, vagueName:value,pageNum:this.state.inquiryPage })
            .then((res) => {
                if (res.code == 0 && res.data != null) {
        ...
        Api
            .getDeptList({numPerPage: 3, searchName: !!value ? value : ' '})
            .then((res) => {
                if (res.code == 0 && res.data != null) {
                    this.setState({
    ...
    getValue(e) {
        ...
        console.log("search2",this.state.inquiryPage)
// 获取搜索结果
        clearTimeout(this.searchTimer || '');
        this.searchTimer = setTimeout(() => {
            this.search(this.state.searchValue);
