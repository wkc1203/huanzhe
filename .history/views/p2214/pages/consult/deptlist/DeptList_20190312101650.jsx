...
class Widget extends Component {
    ...
    componentDidMount(){
        ...
        if(window.localStorage.deptShow=='2'&&window.localStorage.deptListStatus){
            ...
            console.log('height',window.localStorage.scrollHeight)
            document.body.scrollTop=window.localStorage.scrollHeight;
            console.log('height12', document.body.scrollTop)
        }else{
    ...
    getJs(){
        Api
            ...
            .then((res) => {
                ...
                if(window.localStorage.deptShow=='2'&&window.localStorage.deptListStatus){
                    console.log('height11',window.localStorage.scrollHeight)
                    document.getElementsByClassName("page-dept-list")[0].scrollTop=window.localStorage.scrollHeight;
                    console.log('height12',document.getElementsByClassName("page-dept-list")[0].scrollTop)
                }
            }, (e) => {
            });
    }
                                ...
                                return (
                                    <div 
                                     onClick={()=>{
                                        ...
                                        window.localStorage.scrollHeight=window.scrollY;
                                        this.context.router.push({
