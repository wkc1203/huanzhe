        ...
        Api
            ...
            .then((res) => {
                ...
                if(window.localStorage.deptShow=='2'&&window.localStorage.deptListStatus){
                    ...
                    document.getElementsByClassName("dept")[0].scrollTop=window.localStorage.scrollHeight;
                    console.log('height12',document.getElementsByClassName("dept")[0].scrollTop)
                }
            }, (e) => {
            });
    }
