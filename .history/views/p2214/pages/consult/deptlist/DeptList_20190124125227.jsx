...
class Widget extends Component {
    ...
    componentWillUnmount(){
        if(this.state.has){
            window.localStorage.login_access_token=null;
        }
    ...
    loadMoreDataFn() { 
         if(this.state.searchValue!=''&&this.state.search1){
             ...
             if(this.state.inquiryPage<=this.state.maxinquiryPage){
                console.log("page1"+this.state.incur+this.state.incurrent)

                if(this.state.incur!=this.state.incurrent){
                    this.search(this.state.searchValue);
    
                 }
                 var incur=this.state.incurrent;
                 this.setState({
                     incur:incur
                 })
             }
             ...
             if(this.state.searchPage<=this.state.maxsearchPage){
                 if(this.state.cur!=this.state.current){
                    this.selectDept(this.props.location.query.deptName, this.props.location.query.deptId,this.state.searchPage)
    ...
    getDocList(deptId = '',page) {
        if(page==1){
            ...
            console.log("eee",this.state.docList)
            this.showLoading();
            Api
                ...
                .then((res) => {
                    ...
                    if (res.code == 0 && res.data != null) {
                        ...
                        console.log(res.data.currentPage,this.state.searchPag)
                        if(res.data.currentPage==1&&this.state.searchPag!=1){
                            location.reload();
                        }
...
// 获取搜索结果
   ...
   /*搜索*/
    search(value) {
         ...
         console.log("yyy",this.state.inquiryPage,this.state.incurrent)
         
            Api
            .getInfo({numPerPage:5, vagueName:value,pageNum:this.state.inquiryPage })
            .then((res) => {
                if (res.code == 0 && res.data != null) {
                ...
                if(res.data.currentPage==1&&this.state.inquiryPage!=1){
                   ...
                   console.log("state",this.state.inquiryPage,currentPage)
                    this.setState({
                        ...
                        incurrent:this.state.inquiryPage,
        ...
        Api
            .getDeptList({numPerPage: 5, searchName: !!value ? value : ' '})
            .then((res) => {
                if (res.code == 0 && res.data != null) {
                    this.setState({
