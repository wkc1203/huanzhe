...
class Widget extends Component {
    ...
    constructor(props) {
     ...
     callback() {
        ...
        if (top && top < windowHeight) {
            ...
            console.log("tt1",this.state.scrollTop)
            that.loadMoreDataFn();
        }
    }
    componentDidMount(){
        ...
        window.addEventListener('scroll', function () {
            ...
            timeCount = setTimeout(this.callback(), 2000);
        }.bind(this), false);
    ...
    loadMoreDataFn() { 
         if(this.state.searchValue!=''){
            console.log("page1",this.state.inquiryPage,this.state.maxinquiryPage)
            ...
            .then((res) => {
                ...
                if (res.code == 0 && res.data != null) {
                    if(this.state.scrollTop!=''){
                        console.log("tt",this.state.scrollTop);
                        document.getElementsByTagName
                        document.getElementsByTagName("body")[0].scrollTop=this.state.scrollTop;
                        window.screenTop=this.state.scrollTop;
                        window.scrollY=this.state.scrollTop;
                    }
