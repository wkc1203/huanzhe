                                    ...
                                    <Link to={{
                                        ...
                                        <div className="doc-info">
                                            <div className='docImg'>
                                                <img className="doc-img" src={item1.image&&item1.image.indexOf("ihoss")=='-1'?item1.image:item1.image+"?x-oss-process=image/resize,w_105"} alt="医生头像"/>
                                            </div>
                    ...
                    {docList.length > 0 && docList.map((item, index)=> {
                            return (
                                <Link to={{
                                    ...
                                    <div className="doc-info">
                                        <div className='docImg'>
                                            <img className="doc-img" src={item.image.indexOf("ihoss")=='-1'?item.image:item.image+"?x-oss-process=image/resize,w_105"} alt="医生头像"/>
                                        </div>
