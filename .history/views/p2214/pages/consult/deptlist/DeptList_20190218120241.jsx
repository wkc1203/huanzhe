         ...
         if(this.state.searchValue!=''&&this.state.search1){
            console.log("this.state.inquiryPage",this.state.inquiryPage,this.state.maxinquiryPage)
             ...
             if(this.state.inquiryPage<=this.state.maxinquiryPage){
                    ...
                    this.search(this.state.searchValue,this.state.inquiryPage);
...
// 获取搜索结果
        ...
        this.searchTimer = setTimeout(() => {
            this.search(this.state.searchValue,1);
        }, 200);
    }
   /*搜索*/
    search(value,page) {
         ...
         console.log("yyy",this.state.inquiryPage,this.state.incurrent)
            Api
            .getInfo({numPerPage:3, vagueName:value,pageNum:page })
            .then((res) => {
                if (res.code == 0 && res.data != null) {
              ...
              //  if(res.data.currentPage==1&&this.state.inquiryPage!=1){
               ...
               // }
                   console.log("state",this.state.inquiryPage,currentPage)
                    this.setState({
                        inquiryPage:this.state.inquiryPage,
