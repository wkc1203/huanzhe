...
// 获取搜索结果
    ...
    render() {
        const {msg,docList,data, hasMore,searchValue,searchList,search1,searchDoctorList,doctorShow}=this.state;
                                    ...
                                    <Link to={{
                                        ...
                                        <div className="doc-info">
                                            <div className='docImg'>
                                                <img className="doc-img"  alt="医生头像" src={item1.image&&item1.image.indexOf("ihoss")=='-1'?item1.image:item1.image+"?x-oss-process=image/resize,w_105"} />
                                            </div>
