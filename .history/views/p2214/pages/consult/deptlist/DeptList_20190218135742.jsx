...
class Widget extends Component {
    ...
    getDocList(deptId = '',page) {
        ...
        this.setState({
            ...
            Api
                .getInfo({numPerPage:4, deptId, vagueName: '',pageNum:page})
                .then((res) => {
                    this.hideLoading();
    ...
    search(value,deptId,page) {
        this.setState({
         ...
         console.log("yyy",this.state.inquiryPage,deptId,this.state.incurrent)
            Api
            .getInfo({numPerPage:4,deptId:deptId||'', vagueName:value,pageNum:page })
            .then((res) => {
                if (res.code == 0 && res.data != null) {
                     this.hideLoading();
                    var  currentPage=page+1;
        ...
        Api
            .getDeptList({numPerPage: 4, searchName: !!value ? value : ' '})
            .then((res) => {
                if (res.code == 0 && res.data != null) {
                    this.setState({
