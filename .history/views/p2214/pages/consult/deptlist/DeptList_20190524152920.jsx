...
class Widget extends Component {
    ...
    componentWillMount(){
        ...
        console.log("this.props.location.query.type=='2'",this.props.location.query.type=='2'?'2':'1')

    }
    componentDidMount(){
        const that = this; // 为解决不同context的问题
        let timeCount;
        console.log("this.props.location.query.type=='2'",this.props.location.query.type=='2')
        this.setState({
            type:this.props.location.query.type=='2'?'2':'1'
        })
        console.log("this.props.location.query.type=='2'",this.state.type);
