                        ...
                        for(var i=0;i<report.length;i++){
                          ...
                          var j; 
                                for(j=0;j<report[i].report.length;j++){
                                     if(j==0){
                                        var vDate=new Date(report[i].report[j].Visit_date).valueOf();
                                        var nDate=new Date().getTime();
                                        console.log("date",vDate.toString().substring(0,vDate.length-3),nDate.toString().substring(0,nDate.length-3)) 
                                     }
