         ...
         Api
             ...
             .then((res) => {
                  if(res.code==0){
                      ...
                      console.log("tt",this.state.patList)
                      var p=this.state.patList[0];
                      var s=[];
                      s.push(p)
                      console.log('p',s);
                      this.setState({
            ...
            {patList&&patList.map((item,index)=>{
                return(
                    <p
                        ...
                        {patList.length==1&&<span style={{left:'39%'}} className={`${item.patientName.length<=2?'len2':item.patientName.length==3?'len3':'len4'}`}></span>}
