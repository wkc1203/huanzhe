  ...
  goInquiry(){
   ...
   addQuiry(visitNo){
    ...
    console.log(params)
       ...
       .then((res) => {
            if(res.code==0){
                        if(res.data.inquiryId!=null&&res.data.inquiryId!=''){
                            this.hideLoading();
                            console.log(res);
                            this.setState({
           ...
           this.hideLoading();
           if(e.data.inquiryId!=null&&e.data.inquiryId!=''){
            this.hideLoading();
            console.log(res);
            this.setState({
                msg:'当前咨询完成后，才能对医生发起新的咨询',
                        ...
                        return(
                            ...
                            {item1.type=='1'&&item1.Results_rpt_date_time&&<p className='name rightTab' onClick={()=>{
                             ...
                             {item1.type=='2'&&item1.Report_date_time&&<p className='name rightTab' onClick={()=>{
                                ...
                                <span style={{fontSize:'14px'}}>{item1.type=='1'?item1.Sheet_title+'  ':item1.Exam_item+'  '  }   </span>   
