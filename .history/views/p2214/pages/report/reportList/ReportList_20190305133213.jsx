                      ...
                      for(var i=0;i<report.length;i++){
                        ...
                        var j;
                              for(j=0;j<report[i].report.length;j++){
                                     if(report[i].report[j].report_result.length>0){
                                          yes++;
                                     }else{
                                         no++;
                                     }
        ...
        {reportList[currentId]&&reportList[currentId].map((item,index)=>{
            return(
                ...
                <div className='reportPerson'>
                    <p className='time'><span style={{fontSize:'12px',fontWeight:'normal'}}>检查时间：</span> <span style={{fontSize:'14px',fontWeight:'bold'}}>{item.report[0].type=='1'?item.report[0].Requested_date_time:item.report[0].Req_date_time}</span></p>
                    ...
                    </div>
                {
                    item.report&&item.report.map((item1,index1)=>{
                        return(
                            ...
                            }}><span style={{fontSize:'12px',color:'#999'}}>检查项：</span> <span style={{fontSize:'14px',color:'#333'}}>{item1.type=='1'?item1.Sheet_title+'  ':item1.Exam_item+'  '  }   </span>    <span style={{fontSize:'14px',color:'#4dabc7'}}>{item1.report_result.length>0?'(已出结果)':''}</span></p>
                        </div>
                        )
