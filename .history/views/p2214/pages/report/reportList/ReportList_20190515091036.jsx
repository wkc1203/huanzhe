        ...
        {reportList&&reportList.length>0&&reportList.map((item,index)=>{
            return(
                ...
                <div className='reportPerson'>
                    ...
                    {(item.inquiryId=='0'&&item.getTime!=='1'&&item.allOnLineReportResult==1&&item.reportInterpretateFlag=='1')||(item.inquiryId=='0'&&item.hasTimeOut!=='1'&&item.allOnLineReportResult==1&&item.reportInterpretateFlag=='1')&&<span className='yes' onClick={()=>{
                        //已出未解读
