                                               ...
                                               style={{width:'280px',height:'auto',background:'white'}} >
                                                <p className='doctort'>{!!item.checkContent&&item.checkContent.title}</p>
                                                    ...
                                                    <p className='doctort'>{!!item.checkContent&&item.checkContent.title}</p>
                                                        ...
                                                        <div className='check-img'>
                                                        <img  style={{paddingTop:'12px'}} src="{{item.checkContent.img}}"/>
                                                        </div>
                                                        <div className='info'>
                                                                <p class='context' style={{lineHeight:'20px',paddingBottom:'0',height:'50px',paddingTop:'7px'}}>

                                                                {{item.checkContent.content}}</p>
                                                            </div>
                                                        </div>
                                                        <p className='search'>
                                                        查看详情
