                                                ...
                                                //    </div>    
                                                  ...
                                                  {<img className="rd" src="../../../resources/images/rd.png"
                                                    ...
                                                    {<div style={{position:'relative'}} >  
                                                       {<img    src="../../../resources/images/r1.png"  style={{width:'4px',height:'4px',position:'absolute',left:'15px',top:'18px'}}/>}
                                                       {<img  src="../../../resources/images/r2.png"   style={{width:'4px',height:'12px',position:'absolute',left:'20px',top:'14px'}}/>}
                                                       {<img   src="../../../resources/images/r3.png"  style={{width:'5px',height:'18px',position:'absolute',left:'24px',top:'11px'}}/>}
                                                   </div>    }
