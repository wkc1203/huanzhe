  ...
  /*发送信息*/
   ...
   /*获取焦点事件*/
    input(e) {
        ...
        console.log(this.state.inputText,this.state.msgText)
        if(e.target.value!=''){
            this.setState({
                isBtn:true
            }) 
        ...
        if(window.getComputedStyle(document.getElementById("inputText")).height!='40px'){
            this.setState({
                hieghtMore:true
            })
        }
