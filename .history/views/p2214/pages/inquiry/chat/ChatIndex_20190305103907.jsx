                            ...
                            console.log("sss1")
                             ...
                             var that=this; 
                              ...
                              //  socket = io.connect('wss://tih.cqkqinfo.com/?inquiryId=1551686053952&doctorId=doctor900');
                               ...
                               socket = io.connect("https://tih.cqkqinfo.com/?inquiryId="+that.props.location.query.inquiryId+"&userId=user"+that.state.userId,{'reconnect': true });
                                  console.log("socket1",socket.connected);
                                   if(!socket.connected){
                                       console.log("yyy",socket.connected);
                                      // that.getChat(3);
                                   }  
