                ...
                if (res.code == 0) {
                    ...
                    if (res.code == 0) {
                        ...
                        for(var j=0;j<this.state.list.length;j++){
                            if(this.state.list[j].direction=='TO_USER'){
                                this.noDoctor=true;
                                break;
                            }
                        };
...
//评价标签
   ...
   /*播放语音*/
    ...
    const {isEvaluate,files,orderId,list,msgText,isShow,isEnd,docInfo,userInfo,doctorid,deptid,showPlus,interval,
        ...
        newTime,doctorName,noDoctor,status,msg,endding,end,sign,signature,formData,policy,callback,OSSAccessKeyId,key,evaluateTime,isBtn,inputText,isPlay,prevText,nextprevText}=this.state
