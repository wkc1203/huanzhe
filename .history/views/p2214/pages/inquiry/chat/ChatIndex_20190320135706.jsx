  ...
  /*发送信息*/
   ...
   /*获取焦点事件*/
    input(e) {
        ...
        console.log(parseInt(window.getComputedStyle(document.getElementById("inputText")).height.substring(0,window.getComputedStyle(document.getElementById("inputText")).height.length-2)))
