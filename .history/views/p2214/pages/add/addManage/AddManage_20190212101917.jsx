            ...
            <div className="container">
                ...
                <div className="doctorInfo">
                    ...
                    {info.orederStatus=='0'&&info.isPay=='0'&&info.isVisit=='0'&&<div className="confirm" onClick={()=>{
                        ...
                        this.context.router.push({
                            pathname:'/add/addtip',
                            query:{status:0,hospitalTradeno:this.state.id,orderId:this.state.orderId,userId:this.state.userId,type:1,orderId:this.state.orderId,inquiryId:this.state.inquiryId,source:this.props.location.query.source,hospitalUserId:this.state.hospitalUserId,hospitalTradeno:this.state.hospitalTradeno}
                        })
                    }} >
                    ...
                    {info.orederStatus=='1'&&info.isPay=='0'&&info.isVisit=='0'&&<div className="confirm" onClick={()=>{
                        ...
                        this.context.router.push({
                            pathname:'/add/addtip',
                            query:{status:1,hospitalTradeno:this.state.id,orderId:this.state.orderId,userId:this.state.userId,type:1,orderId:this.state.orderId,inquiryId:this.state.inquiryId,source:this.props.location.query.source,hospitalUserId:this.state.hospitalUserId,hospitalTradeno:this.state.hospitalTradeno}
                        })
                    }} >     
                        <img  src="../../../resources/images/confirm1.png"/>
                    </div>}
