...
hideDialog() {
   ...
   deptListFull() {
    ...
    charScroller(scrollerId) {
        ...
        console.log("sss",s)
        document.getElementsByClassName("main-content")[0].scrollTop=s;
        console.log('ehig',document.getElementsByClassName("main-content")[0].scrollTop)
        this.setState({
        ...
        <div className="d-page">
          ...
          return (
              <div className='main-content'>
                ...
                <div className={`letters-item ${item?item:''}`} key={index} id={index} >{item}</div>
