...
class Widget extends Component {
    ...
    confrim(){
        if(this.state.checkInfo.status=='1'){
            var replaceUrl=window.location.origin+"/views/p099/#/consult/pay?orderId="+this.state.checkInfo.orderIdStr+"&totalFee="+
                                ...
                                return (
                                    <div className='info rightTab' onClick={()=>{
                                        this.context.router.push({
                                            ...
                                            query:{doctorName:checkInfo.doctorName,content:JSON.stringify(item)}
                                        })
                                    }}> 
                ...
                <div className='check-status'>
                  ...
                  <div className='status-item rightTab' onClick={()=>{
                    this.context.router.push({
                        ...
                        query:{patientId:checkInfo.patientId}
                    })
