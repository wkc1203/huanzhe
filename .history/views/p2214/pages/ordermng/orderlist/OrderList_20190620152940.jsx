...
if(type==3){
  ...
  render() {
    ...
    console.log("check",checkList.length<=0,checkList!='')
    return (
    <div className="container page-order-list">
        ...
        {item2Show&&
            ...
            {isPatShow&&<div className='modal2' >
                ...
                {manageList.length<0&&manageList!=''&&<div  style={{marginTop:'25%'}}>
        ...
        {item1Show&&<div>
            ...
            {orderList.length <= 0&&orderList!=''&&<NoResult  msg='暂未查询到相关信息'/>
            }
         </div>}
        {item3Show&&
        ...
        {isPatShow&&<div className='modal2' >
            ...
            {checkList.length <= 0&&checkList!=''&&<NoResult  msg='暂未查询到相关信息'/>}
            </div>
        }
