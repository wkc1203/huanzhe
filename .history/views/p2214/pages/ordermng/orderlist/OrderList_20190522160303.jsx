            ...
            {orderList&&orderList.map((item,index)=>{
               return(
                   <div className='doc-item' key={index}>
                        <Inquiry  id={item.id} userId={this.props.location.query.userId} doctorName={item.doctorName}
                        createTime={item.createTime} finishTime={item.finishTime} totalFee={item.totalFee}
                        doctorImg={item.doctorImgUrl} deptName={item.deptName} level={item.level} hisName={item.hisName}
                        />
                        <Patient  typeName={item.typeName} patientName={item.patientName}
                        statusName={item.statusName} status={item.status} id={item.id}
        ...
        {isPatShow&&<div className='modal2' >
...

            {
                ...
                {checkList&&checkList.map((item,index)=>{
                    return(
                        <Check  index={index}  timeText={item.timeText} patientName={item.patientName}
