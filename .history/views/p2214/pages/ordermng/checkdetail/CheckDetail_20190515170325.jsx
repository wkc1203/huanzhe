         ...
         <Dialog {...this.state.dialogConfig} >
          ...
          <div className='person-info'>
               <div >
                  ...
                  <p style={{textAlign:'right'}}>年龄：{!!checkDetail.onlineCheckListCaseVo&&checkDetail.onlineCheckListCaseVo.patientAge?checkDetail.onlineCheckListCaseVo.patientAge:''}岁</p>
               </div>
               <div>
