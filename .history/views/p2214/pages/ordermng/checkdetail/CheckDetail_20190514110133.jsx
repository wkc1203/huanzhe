    ...
    return (
        <div className="container page-check-detail">
         ...
         >取消检验检查</p>
              ...
              {!!checkDetail&&(checkDetail.status=='4'||checkDetail.status=='5')&& <p className='cancel'>支付异常</p> }
              {!!checkDetail&&(checkDetail.status=='4'||checkDetail.status=='6')&& <p className='cancel'>支付失败</p> }
