               ...
               <div className='title'>
                ...
                <div className='info'>
                   ...
                   <div className='item'>
                      <p>支付流水号</p>
                      <p>
                      {item.paySerialNumber&&<span key={index} style={{paddingLeft:'10px',display:'block'}}>
                        {item.paySerialNumber}
                      </span>}
                      {checkDetail.subPaySerialNumber&&<span key={index} style={{paddingLeft:'10px',display:'block'}}>
