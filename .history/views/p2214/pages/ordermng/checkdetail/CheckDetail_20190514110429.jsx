    ...
    return (
        <div className="container page-check-detail">
         ...
         >取消检验检查</p>
              ...
              {!!checkDetail&&(checkDetail.status=='4'||checkDetail.status=='3')&& <p className='cancel' style={{color:'#f57f17'}}>支付异常</p> }
              {!!checkDetail&&(checkDetail.status=='4'||checkDetail.status=='3')&& <p className='cancel' style={{color:'red'}}>支付失败</p> }
