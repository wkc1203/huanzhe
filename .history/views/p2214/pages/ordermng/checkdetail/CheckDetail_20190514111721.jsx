    ...
    return (
        <div className="container page-check-detail">
         ...
         >取消检验检查</p>
              ...
              {!!checkDetail&&(checkDetail.status=='3')&& <p className='infos'>对不起，由于系统网络原因导致本次缴费异常，我们将在3个工作日内为您及时处理。</p> }
              {!!checkDetail&&(checkDetail.status=='3')&& <p className='infos'>对不起，由于系统网络原因导致本次缴费失败，我们将在3个工作日内为您及时处理。</p> }
