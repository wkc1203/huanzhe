   ...
   /*播放语音*/
    ...
    searchCheck(id){
         ...
         this.context.router.push({
             ...
             query:{id:id,orderId:this.state.orderId,inquiryId:this.state.inquiryId}
         })
    }
    //查看加号详情
    into(id){
        this.context.router.push({
            pathname:'/add/addConfirm',
            query:{id:id,inquiryId:this.state.inquiryId,userId:this.state.uId,patHisNo:this.state.patHisNo}
        })
                                    ...
                                    <div key={index} className="content-item">
                                        ...
                                        <div className='left'
                                            ...
                                            {item.url && item.action == 'add' && <div
                                                ...
                                                >
                                                <i/><img style={{width:'223px',height:'86px',maxWidth:'223px'}} src={item.url}/>
                                            </div>}
                                        ...
                                        <div id="s" className='right'>
                                            ...
                                            {item.url && item.action == 'addcheck' && <div
                                                className='image'
                                                onClick={()=>{
                                                                    this.searchCheck(item.actionTrigger)
