  ...
  getHospIntro() {
    ...
    clock() {
     ...
     pushData() {
        this.showLoading();
        const value = this.getFormData();
        //const registerRes = await Api.register(value);
         console.log(value);
         Api
             .register(value)
             .then((res) => {
        ...
        <div className="container page-login">
            ...
            <div className="register-input">
                <form >
                    <div className="register-list">
                        <div className="register-listitem1">
                            ...
                            <div className="listitem-body">
                                ...
                                {/*<input
                                 className="m-content {{errorElement.name ? 'o-error' : ''}}" placeholder="请输入姓名"
                                 cursor-spacing="100" placeholder-style="color:{{errorElement.name ? 'color: #ff613b;' : ''}}"
                                 maxlength="8" id="name" value="{{name}}" @blur="validator" @input="userIO" @focus="resetThisError"
                                 />*/}
                            </div>
                        </div>
                        <div className="register-listitem1">
                            ...
                            <div className="listitem-body">
                                <input
                                    ...
                                    />
                                {/*<input
                                 className="m-content {{errorElement.idNo ? 'o-error' : ''}}" type="idcard"
                                 placeholder="请输入身份证号" placeholder-style="color:{{errorElement.idNo ? 'color: #ff613b;' : ''}}"
                                 value="{{idNo}}" id="idNo" maxlength="18" cursor-spacing="100" @blur="validator" @input="userIO" @focus="resetThisError"
                                 />*/}
                        ...
                        <div className="register-listitem1">
                            ...
                            <div className="listitem-bd">
                                <input className="m-content"  placeholder="请输入手机号码"
                                    ...
                                    />
                                {/*<input className="m-content {{errorElement.phone ? 'o-error' : ''}}" type="number" placeholder="请输入手机号码"
                                 cursor-spacing="100" @input="userIO" @focus="resetThisError" auto-focus="{{getFocus}}"
                                 placeholder-className="color:{{errorElement.phone ? 'color: #ff613b;' : ''}}"
                                 id="phone" maxlength="11" @blur="validator" value="{{phone}}"
                                 />*/}
                            </div>

                            {/* <button className="listitem-ft" >获取手机号</button><button className="listitem-ft"  open-type="getPhoneNumber" bindgetphonenumber="getPhoneNumber"  >获取手机号</button>*/}
                        </div>
                        <div className="register-listitem1">
                            <div className="listitem-head">
                            ...
                            <div className="listitem-body">
                                ...
                                {/*<input className="m-content" type="number" placeholder="请输入验证码"
                                 cursor-spacing="100" @input="userIO"
                                 id="validateCode" maxlength="6" value="{{validateCode}}"
                                 />*/}
                            </div>
                            ...
                            {/*<div wx:if="{{!isSendValidate}}" className="listitem-ft" @tap="getValidate">获取验证码</div>
                             <div wx:if="{{isSendValidate}}" className="listitem-ft ft-disabled">{{leftTime}}s 后重试</div>*/}
                        </div>
                    </div>
                    <div className="check-box">
                        {/*<checkbox   @tap="changeChecked" value="{{isChecked}}" checked="{{!!isChecked}}" color="#4FABCA"/>同意 <span >医患在线就诊协议</span>*/}
                        <label className="weui-agree">
                            <input type="checkbox"  defaultChecked={isChecked} className="weui-agree__checkbox" onClick={(e) => {
                    ...
                    <div className="btn">
                        <button className={`submit-btn ${!hasErr&&isChecked?'':'o-disabled'}`}
                                onClick={(e)=>{
                                    this.formSubmit(e)
                                    }}>立即注册</button>
                        {/*<button className="submit-btn {{(hasErr || !isChecked) ? 'o-disabled' : ''}}" formType="submit">立即注册</button>*/}
                    </div>
                </form>
            </div>
                ...
                <div className='modal-body-protocol'>
                    ...
                    <div className='modal-content-protocol'>
                        <div >
                            ...
                            <div className="content-item">7.2 本平台有权对本协议条款不时地进行修改，并在本平台张贴，无须另行通知用户，本平台对本协议及本客户端内容拥有解释权。
                            </div>
                            ...
                            <div className="content-item">2）因使用本协议项下的服务，遭受他人误导、欺骗或其他导致或可能导致的任何心理、生理上的伤害以及经济上的损失；</div>
                            ...
                            <div className="content-item">10.2 因本协议产生之争议，由双方协商解决；协商不成的，任何一方都有权向有管辖权的中华人民共和国大陆地区法院提起诉讼。
                            </div>
