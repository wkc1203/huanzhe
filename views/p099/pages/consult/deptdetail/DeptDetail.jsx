                            ...
                            <div>
                                {docInfo.name}
                                {
                                    docInfo.inquirys && docInfo.inquirys.map((item, index)=> {
                                        return (
                                            <div key={index}
                                                 className={`${item.type=='1'&&item.isOnDuty=='0'?'status-item1':'disNo'} ${item.type=='1'&&item.isOnDuty=='1'?'status-active1':'disNo'}`}>{item.type == '1' && item.isOnDuty == '1' ? '在线' : ''} {item.type == '1' && item.isOnDuty == '0' ? '离线' : ''}</div>
