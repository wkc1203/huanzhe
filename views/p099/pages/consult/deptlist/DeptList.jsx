                                        ...
                                        <div className="text-box1">
                                            <div className='doc-name'>{item.name}
                                                {item.inquirys.map((item1, index1)=> {
                                                    return (
                                                        <div key={index1}
                                                             className={`status-item1 ${item1.type == '1'?'':'disNo'} `}>
                                                            {item1.isFull == '1' && item1.type == '1' &&
                                                            <div className="status-item">已满</div>}
                                                            {item1.isFull != '1' && item1.isOnDuty == '1' && item1.type == '1' &&
                                                            <div className="status-active">在线</div>}
                                                            {item1.isFull != '1' && item1.isOnDuty == '0' && item1.type == '1' &&
                                                            <div className="status-item">离线</div>}
                                                        </div>
                                                    )
                                                })}
                                            ...
                                            <div
                                                className='doc-des1 ellipsis'>{item.specialty ? item.specialty : '暂无描述'}</div>
                                        </div>
                                    </div>
                                    <div className='oper-box'>
                                        {item.inquirys.map((item1, index1)=> {
