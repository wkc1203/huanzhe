...
import * as Api from './patientinfoapi';
               ...
               <div className='barcode'>
                ...
                <div className="m-userinfo">
                   ...
                   <div className="userinfo-item" >
                        <div className="item-tits">性别:</div>
                        <div className="item-txt">{userInfo.sex === 'M' ? '男' : '女'}</div>
                    </div>
                  <div className="userinfo-item" >
                        <div className="item-tits">年龄:</div>
                        <div className="item-txt">{userInfo.age}</div>
                    </div>
                    <div className="userinfo-item" >
                        <div className="item-tits">身份证号:</div>
                        <div className="item-txt">{userInfo.idNo}</div>
                    </div>
                    <div className="userinfo-item">
                        <div className="item-tits">手机号:</div>
                    ...
                    <div className="userinfo-item">
                        <div className="item-tits">地址:</div>
                        <div className="item-txt">{userInfo.adress}</div>
                    </div>
                </div>
                ...
                {this.props.location.query.source!='1'&&<div className="mu-list">
                    ...
                    <div className="m-btn">
                        ...
                        <div className="btn-item default-btn delete" onClick={()=>{
                    this.unBind1()
