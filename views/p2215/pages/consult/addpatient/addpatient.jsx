    ...
    >
        <div className="register-listitem1 ">
            <div className="listitem-head ">
                <text className="list-title">{props.children}</text>
            </div>
            <div className="listitem-body">
            <div className="m1-content colorccc">{props.extra}</div>
            </div>
        </div>
    </div>
);
                        ...
                        <div className="register-input">
                            <div className="register-list">
                                <div className="register-listitem1">
                                    ...
                                    <div className="listitem-body">
                                        <input
                                            ...
                                            id="patientName" value={patientName}
                                            onBlur={(e) => {
                                                window.scrollTo(0, 0);
                                                this.validator1('patientName')
                                            }}
                                            onFocus={(e) => {
                                ...
                                {/* <Input type="text"
                                            ...
                                            readOnly={true}
                                        /> */}
                                <List style={{ backgroundColor: 'white' }} className='padleft'>
                                    <Picker
                                        className="m1-content inputs"
                                        title="选择地区"
                                        extra="请选择所在地区"
                                        ...
                                        value={this.state.city_value}
                                        onChange={label =>{
                                            console.log(label,"vv")
                                            this.setState({ city_value: label})} }
                                        onOk={label => this.setState({ city_value: label})}
                                    >
                                        <CustomChildren className="titleadress">地址</CustomChildren>
                                    </Picker>
                                </List>
                                {/* </div>
                                </div> */}
                                ...
                                <div className="register-listitem1 ">
                                    ...
                                    <div className="listitem-bd">
                                        ...
                                        >获取验证码</div>}
                                        {isSendValidate && <div className="listitems-ft ft-disabled colorwrite">
                                            {leftTime} s 后重试
                                </div>}
                                    </div>
                                </div>
