...
class Widget extends Component {
  ...
  componentDidMount() {
    ...
    switchInquiry() {
        ...
        var replaceUrl="https://tih.cqkqinfo.com/views/p2215/#/inquiry/inquirylist";
        top.window.location.replace(replaceUrl);

    }
    /*查看更多医生*/
    goDoctor(){
        var replaceUrl="https://tih.cqkqinfo.com/views/p2215/#/consult/deptlist?type=1&source=0";
        top.window.location.replace(replaceUrl);
                             ...
                             docList.map((item, index) => {
                                 return (
                                     <div key={index} style={{paddingTop:'15px'}}>
                                         ...
                                         query:{doctorId:item&&!!item.doctorId?item.doctorId:'',deptId:item.deptId,resource:1}
