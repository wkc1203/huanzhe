                ...
                <div className='content'>
                    <div className='d-tab'>
                        ...
                        {type == '1' && <div className="main-func1">
                            ...
                            {(docInfo.doctorId== '900' || docInfo.doctorId== '001'|| docInfo.doctorId=='400460'|| docInfo.doctorId=='481059'|| docInfo.doctorId=='400704'|| docInfo.doctorId=='480746'||docInfo.doctorId=='481995') && <DoctorInfo1 img='./././resources/images/describe_mb.png' txt='慢病/处方' txt1='在线申请处方' url='/consult/describe' doctorId={docInfo.doctorId} deptId={docInfo.deptId} com='2'></DoctorInfo1>}
                            {(docInfo.doctorId!= '900' && docInfo.doctorId!= '001'&& docInfo.doctorId!= '400460'&& docInfo.doctorId!= '481059'&& docInfo.doctorId!= '400704'&&docInfo.doctorId!='480746'&&docInfo.doctorId!='481995') && <DoctorInfo1 img='./././resources/images/doctor-check.png' txt='慢病/处方' txt1='在线申请处方' url=''></DoctorInfo1>
                            }
                        </div>}
                    </div>
