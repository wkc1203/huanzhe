...
import * as Api from './reportOrderListApi';
...
//批量隐藏功能
  ...
  render() {
    const {patientName,clickItem,isPatShow,orderList,patList,msg}=this.state
    return (
    <div className="container page-order1-list">
        ...
        <div className="classify">
          <p className="item-active">咨询 <span></span></p>
          <p>加号<span></span></p>
          <p>病历<span></span></p>
        </div>
