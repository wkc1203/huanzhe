...
class Widget extends Component {
    ...
    complain(param) {
        ...
        console.log(this.state.isSub,"isSub")
        Api
            .addReply(param)
            .then((res) => {
    ...
    submitData() {
        ...
        //     this.setState({
        //         isshow:true,
        //         changetips:"请输入追加回复内容"
        //     })
        // }else if(this.state.content.length > 100){
        //     this.setState({
        //         isshow:true,
        //        changetips:"描述不能多于100个字",
        //     })
             
        // }
        let errMsg = !this.state.content
            ? '请输入追加回复内容'
        ...
        if (errMsg) {
         ...
         //   this.toptip = errMsg;
        //    console.log( this.toptip," toptip")
            setTimeout(() => {
                this.setState({
                    toptip: ''
                })
        ...
        if (len == 0) { 
            ...
            // }else{
                const params = {
                    replyUrl: this.state.pics,
                    replyContent: this.state.content,
                    complaintsId:this.props.location.query.id,
                    type:1
                    //replyContent: this.state.reason,
                };
                this.complain(params);
    ...
    render() {
        ...
        return (
            <div className="page-complain">
                <div className="home replyhome"><span className="jian"
                                            onClick={()=>{
                ...
                <div className="complain-suggest">
                    <div className="suggest-title">追加回复</div>
                    <div className="area-box">
                    <textarea   placeholder="请输入追加回复的内容"
                                onChange={(e)=>{
                                this.saveContent(e)
                        }}/>
                    </div>
